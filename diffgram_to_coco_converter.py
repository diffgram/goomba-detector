...
client_id = "LIVE__mw933gsuhtdea77102oe"
client_secret = "mcwl2s6631ceqo7i1010vc2z1883vdt1tgdcg8ex7plryg3iomub6elwo2rx"
project = Project(
    project_string_id="goomba-detector",
    client_id=client_id,
...
def build_images_from_instances(coco_path):
    """
        (Utility function)
        Build the images key in the coco file based on the instances avaialable.
    :param coco_path:
    :return:
    """
    file = open(coco_path)
